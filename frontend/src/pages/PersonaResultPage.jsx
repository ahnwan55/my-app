...
const AXES = [
  { key: "지적_확장성",  label: "지적 확장성",  desc: "얼마나 다양한 분야를 폭넓게 탐구하는지를 나타냅니다. 점수가 높을수록 새로운 지식과 낯선 분야에 대한 호기심이 강합니다." },
  { key: "분석적_깊이",  label: "분석적 깊이",  desc: "텍스트를 얼마나 비판적으로 읽고 논리적으로 분석하는지를 나타냅니다. 점수가 높을수록 주석, 참고문헌, 근거까지 꼼꼼히 따져보는 성향입니다." },
  { key: "실용_지향성",  label: "실용 지향성",  desc: "독서를 통해 얻은 지식을 실제 생활이나 업무에 바로 적용하려는 경향을 나타냅니다. 점수가 높을수록 실전 활용을 중시하는 독서 스타일입니다." },
  { key: "감성_몰입도",  label: "감성 몰입도",  desc: "이야기 속 인물과 감정에 얼마나 깊이 공감하고 빠져드는지를 나타냅니다. 점수가 높을수록 서사와 감정 흐름에 민감하게 반응하는 독자입니다." },
  { key: "정보_체계화",  label: "정보 체계화",  desc: "읽은 내용을 얼마나 잘 정리하고 구조화하는지를 나타냅니다. 점수가 높을수록 메모, 요약, 분류 등으로 지식을 체계적으로 관리하는 성향입니다." },
  { key: "사회적_영향도", label: "사회적 영향도", desc: "독서를 통해 얻은 인사이트를 타인과 공유하거나 사회적 담론에 참여하려는 경향을 나타냅니다. 점수가 높을수록 독서를 소통의 도구로 활용합니다." },
];
...
const FALLBACK_SCORES = {
  EXPLORER:  { "지적_확장성":9.0, "분析적_깊이":6.5, "실용_지향성":5.0, "감성_몰입도":4.5, "정보_체계화":6.0, "사회적_영향도":5.5 },
  CURATOR:   { "지적_확장성":6.0, "분析적_깊이":5.5, "실용_지향성":4.5, "감성_몰입도":6.5, "정보_체계화":9.0, "사회적_영향도":6.0 },
  NAVIGATOR: { "지적_확장성":5.5, "분析적_깊이":6.0, "실용_지향성":9.0, "감성_몰입도":3.5, "정보_체계화":7.0, "사회적_영향도":5.0 },
      ...
      <div style={{ marginBottom: 12 }}>
        ...
        {isOpen && (
            <div style={{
              ...
              borderRadius: 10, fontSize: 12, color: C.gray700,
...
const S = {
  ...
  homeBtn:     { fontSize: 13, color: C.gray400, background: "none", border: "none", cursor: "pointer", padding: "0 0 16px", fontFamily: "'Noto Sans KR', sans-serif" },
